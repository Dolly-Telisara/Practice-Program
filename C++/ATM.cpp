	...
	class ATMAccountHolders:public Bank
	    ...
	    {
	    accountNumber = 2408;
	    accountHolders = "Rosie Williams";
	    accountHoldersAddress = "Ockham Road, House no.25";
	    startBalance = 70000.00;
	...
	//==================================================================================================   
	    ...
	    system("cls");
	       ...
	       cout<<"\tThe Interest is calculated over the last SIX months on the average account balance\n";
